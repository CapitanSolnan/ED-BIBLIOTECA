...
public class Main {
    public static void main(String[] args) {
        ...
        menuPrincipal(teclado, biblioteca, gestor);

        teclado.close();
    }

    public static void menuPrincipal(Scanner teclado, Biblioteca biblioteca, GestorBiblioteca gestor) {
    ...
    public static void menuGestor(Scanner teclado, Biblioteca biblioteca, GestorBiblioteca gestor) {
        boolean activado = true;
        while (activado) {
            ConsoleUtils.saltarPagina("--Que vols fer?--");
    ...
    public static void menuStoc(Scanner teclado, Biblioteca biblioteca){
